...
public interface TbTypeTemplateDao {
     ...
     *
     * @param entities List<TbTypeTemplate> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<TbTypeTemplate> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<TbTypeTemplate> entities);
